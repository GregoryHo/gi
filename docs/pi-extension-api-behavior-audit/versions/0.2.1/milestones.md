...
| M3 v0.2.1 release prep | Done | Package and seal v0.2.1 docs/changelog/version after milestones pass | Bumped package/lockfile to 0.2.1, updated changelog/release policy/docs, and passed release verification. No publish/tag. |
