...
| M4 — Worker-assisted goal loops | Planned | `m4-worker-assisted-goal-loops.md` | Delegate planning/review/verification/implementation to `agent-workers` with explicit user approval and workspace context. |
