...
| M2 Versioned worker runtime protocol | Done | Expose one shared worker runtime to separate coordination packages through versioned `pi.events` requests | Plan: `m2-runtime-protocol.md` |
