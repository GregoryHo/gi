...
export function getAgentWorkersHelpLines(): string[] {
  return [
    ...
    "  /worker-run --cwd <path> [--adapter demo|claude-code|codex-cli|pi-sdk] <task>",
    "  /worker-run --pick-cwd [--adapter demo|claude-code|codex-cli|pi-sdk] <task>",
    "  /worker-run --timeout-ms <ms> [--adapter demo|claude-code|codex-cli|pi-sdk] <task>",
    ...
    "  /worker-run --adapter pi-sdk <task>",
    "  /worker-status [id]",
