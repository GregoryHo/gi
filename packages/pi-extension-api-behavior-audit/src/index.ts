...
import { registerApiAuditTools, stopAllActiveApiAuditCaptures, stopAllActiveApiAuditProxySessions } from "./tools/index.ts";
...
export default function apiBehaviorAuditExtension(pi: ExtensionAPI): void {
  ...
  pi.on("session_shutdown", async () => {
    ...
    await stopAllActiveApiAuditProxySessions();
  });
}
