...
import { getActiveJiraBoard, setActiveJiraBoard } from "../../state/context.ts";
import { fetchProjectComponents, fetchProjectIssueTypes, fetchProjectVersions, sortProjectVersionsForPicker } from "../../adapters/metadata.ts";
import { fetchKanbanBoardFilterScope, type KanbanBoardFilterScopeResult } from "../../adapters/kanban.ts";
import { fetchActiveSprintForBoard, type ActiveSprintResult } from "../../adapters/sprints.ts";
import { addIssueFilter, buildFacetedIssueJql, collectIssueFacetValues, type IssueFacetFilter, type IssueFacetType, type IssueFilterState } from "../../core/facets.ts";
import { pageFacetValues, type FacetValueItem } from "../../ui/facet-picker.ts";
import { fetchAssignableUsers } from "../../adapters/users.ts";
